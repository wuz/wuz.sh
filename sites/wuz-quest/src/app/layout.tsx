...
const commitMono = LocalFont({
	src: "../fonts/CommitMono/CommitMono VariableFont.ttf",
	variable: "--font-commit-mono",
});

export const metadata: Metadata = {
	title: "Has Been Wizards",
...
export default async function RootLayout({
	...
	return (
		<html lang="en">
			...
			<body className={`${commitMono.variable} antialiased`}>
				<Verse currentSite="quest" />
				<RouteTracker />
				<div className="font-mono max-w-[80ch] w-screen p-8 orchestration">
					<header
					...
					>
						...
						HBW is a blog by Conlin Durbin, a TTRPG designer and co-owner at{" "}
					...
					<main
						className="my-16 border-y-1 border-y-pink-900 py-8"
					...
					>
						...
						<div className="md:text-center space-y-2">
							<h3 className="font-semibold">Find me on the web</h3>
							<ul>
								<li>
						...
						<div className="md:text-right space-y-2">
							...
							<div className="flex flex-col items-end gap-2">
								<h3 className="font-semibold">Friends & Communities</h3>
								...
								<h3 className="font-semibold">TTRPG Webring</h3>
