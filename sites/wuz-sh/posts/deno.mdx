...
coverImage: "/post_heros/deno.gif"
published: true
---

export const dinosaurs = "https://media.giphy.com/media/3rgXBvnbXtxwaWmhr2/giphy.gif";
...
<figure style={{ "--aspectRatio": "16/9" }}>
  <img src={dinosaurs} alt="People in dino suits dancing" />
</figure>
